...
function selectSeat(no, sclass){
	...
	seat = no - 75;
	seatClass = sclass;
	if(seat < 0 && sclass === 'gold'){
		document.getElementById(no).style.backgroundColor = "#FFD700";
		// document.getElementById(seat).style.color = "white";
		// document.getElementById(seat).style.borderColor = "white";
    }
	else{
		document.getElementById(seatNo).style.backgroundColor = "#F8F8FF";
		document.getElementById(seatNo).style.color = "black";
		document.getElementById(seatNo).style.borderColor = "black";
	}
